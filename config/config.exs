...
config :matwork, MatworkWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: MatworkWeb.ErrorHTML, json: MatworkWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Matwork.PubSub,
  live_view: [signing_salt: "lO3RpSHg"]
...
config :matwork, Matwork.Mailer, adapter: Swoosh.Adapters.Local
